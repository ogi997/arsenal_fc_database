...
public class ControllerSpecTransfers implements Initializable {
    @FXML
    ...
    public void setData(String data) {
        ControllerSpecTransfers.data = data;
    }

    ControllerAllTransfers cat = new ControllerAllTransfers();
    List<AllTransfers> listAllTransfers = cat.getTransferBySeason(data);
