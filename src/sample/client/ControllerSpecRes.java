...
public class ControllerSpecRes implements Initializable {

    private static String data;
    public void setData(String data) { ControllerSpecRes.data = data; }
    ...
    List<AllResults> listAllResults = car.getResultsBySeason(data);
